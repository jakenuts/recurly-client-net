...
namespace Recurly {
  ...
  public class Client : BaseClient {
    ...
    /// <summary>
    /// List sites <see href="https://partner-docs.recurly.com/v2017-09-30#operation/list_sites">list_sites api documentation</see>
    /// </summary>
    ...
    /// <summary>
    /// Fetch a site <see href="https://partner-docs.recurly.com/v2017-09-30#operation/get_site">get_site api documentation</see>
    /// </summary>
    /// <returns>
    /// A site.
    /// </returns>
    ...
    /// <summary>
    /// List a site's accounts <see href="https://partner-docs.recurly.com/v2017-09-30#operation/list_accounts">list_accounts api documentation</see>
    /// </summary>
    /// <param name="ids">Filter results by their IDs. Up to 200 IDs can be passed at once using  commas as separators, e.g. `ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6`.    **Important notes:**  * The `ids` parameter cannot be used with any other ordering or filtering    parameters (`limit`, `order`, `sort`, `begin_time`, `end_time`, etc)  * Invalid or unknown IDs will be ignored, so you should check that the    results correspond to your request.  * Records are returned in an arbitrary order. Since results are all    returned at once you can sort the records yourself.  </param>
    /// <param name="limit">Limit number of records 1-200.</param>
    /// <param name="order">Sort order.</param>
    ...
    /// <summary>
    /// Create an account <see href="https://partner-docs.recurly.com/v2017-09-30#operation/create_account">create_account api documentation</see>
    /// </summary>
    ...
    /// <summary>
    /// Fetch an account <see href="https://partner-docs.recurly.com/v2017-09-30#operation/get_account">get_account api documentation</see>
    /// </summary>
    ...
    /// <summary>
    /// Modify an account <see href="https://partner-docs.recurly.com/v2017-09-30#operation/update_account">update_account api documentation</see>
    /// </summary>
    /// <param name="account_id">Account ID or code (use prefix: `code-`, e.g. `code-bob`).</param>
    /// <param name="body"></param>
    /// <returns>
    ...
    /// <summary>
    /// Deactivate an account <see href="https://partner-docs.recurly.com/v2017-09-30#operation/deactivate_account">deactivate_account api documentation</see>
    /// </summary>
    /// <param name="account_id">Account ID or code (use prefix: `code-`, e.g. `code-bob`).</param>
    /// <returns>
    /// An account.
    ...
    /// <summary>
    /// Fetch an account's acquisition data <see href="https://partner-docs.recurly.com/v2017-09-30#operation/get_account_acquisition">get_account_acquisition api documentation</see>
    /// </summary>
    /// <param name="account_id">Account ID or code (use prefix: `code-`, e.g. `code-bob`).</param>
    /// <returns>
    ...
    /// <summary>
    /// Update an account's acquisition data <see href="https://partner-docs.recurly.com/v2017-09-30#operation/update_account_acquisition">update_account_acquisition api documentation</see>
    /// </summary>
    /// <param name="account_id">Account ID or code (use prefix: `code-`, e.g. `code-bob`).</param>
    /// <param name="body"></param>
    /// <returns>
    ...
    /// <summary>
    /// Remove an account's acquisition data <see href="https://partner-docs.recurly.com/v2017-09-30#operation/remove_account_acquisition">remove_account_acquisition api documentation</see>
    /// </summary>
    /// <param name="account_id">Account ID or code (use prefix: `code-`, e.g. `code-bob`).</param>
    /// <returns>
    ...
    /// <summary>
    /// Reactivate an inactive account <see href="https://partner-docs.recurly.com/v2017-09-30#operation/reactivate_account">reactivate_account api documentation</see>
    /// </summary>
    /// <param name="account_id">Account ID or code (use prefix: `code-`, e.g. `code-bob`).</param>
    /// <returns>
    /// An account.
    ...
    /// <summary>
    /// Fetch an account's balance and past due status <see href="https://partner-docs.recurly.com/v2017-09-30#operation/get_account_balance">get_account_balance api documentation</see>
    /// </summary>
    /// <param name="account_id">Account ID or code (use prefix: `code-`, e.g. `code-bob`).</param>
    /// <returns>
    ...
    /// <summary>
    /// Fetch an account's billing information <see href="https://partner-docs.recurly.com/v2017-09-30#operation/get_billing_info">get_billing_info api documentation</see>
    /// </summary>
    /// <param name="account_id">Account ID or code (use prefix: `code-`, e.g. `code-bob`).</param>
    /// <returns>
    ...
    /// <summary>
    /// Set an account's billing information <see href="https://partner-docs.recurly.com/v2017-09-30#operation/update_billing_info">update_billing_info api documentation</see>
    /// </summary>
    /// <param name="account_id">Account ID or code (use prefix: `code-`, e.g. `code-bob`).</param>
    /// <param name="body"></param>
    /// <returns>
    ...
    /// <summary>
    /// Remove an account's billing information <see href="https://partner-docs.recurly.com/v2017-09-30#operation/remove_billing_info">remove_billing_info api documentation</see>
    /// </summary>
    /// <param name="account_id">Account ID or code (use prefix: `code-`, e.g. `code-bob`).</param>
    /// <returns>
    ...
    /// <summary>
    /// Show the coupon redemptions for an account <see href="https://partner-docs.recurly.com/v2017-09-30#operation/list_account_coupon_redemptions">list_account_coupon_redemptions api documentation</see>
    /// </summary>
    /// <param name="account_id">Account ID or code (use prefix: `code-`, e.g. `code-bob`).</param>
    /// <param name="ids">Filter results by their IDs. Up to 200 IDs can be passed at once using  commas as separators, e.g. `ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6`.    **Important notes:**  * The `ids` parameter cannot be used with any other ordering or filtering    parameters (`limit`, `order`, `sort`, `begin_time`, `end_time`, etc)  * Invalid or unknown IDs will be ignored, so you should check that the    results correspond to your request.  * Records are returned in an arbitrary order. Since results are all    returned at once you can sort the records yourself.  </param>
    /// <returns>
    ...
    /// <summary>
    /// Show the coupon redemption that is active on an account <see href="https://partner-docs.recurly.com/v2017-09-30#operation/get_active_coupon_redemption">get_active_coupon_redemption api documentation</see>
    /// </summary>
    /// <param name="account_id">Account ID or code (use prefix: `code-`, e.g. `code-bob`).</param>
    /// <returns>
    ...
    /// <summary>
    /// Generate an active coupon redemption on an account <see href="https://partner-docs.recurly.com/v2017-09-30#operation/create_coupon_redemption">create_coupon_redemption api documentation</see>
    /// </summary>
    /// <param name="account_id">Account ID or code (use prefix: `code-`, e.g. `code-bob`).</param>
    /// <param name="body"></param>
    /// <returns>
    ...
    /// <summary>
    /// Delete the active coupon redemption from an account <see href="https://partner-docs.recurly.com/v2017-09-30#operation/remove_coupon_redemption">remove_coupon_redemption api documentation</see>
    /// </summary>
    /// <param name="account_id">Account ID or code (use prefix: `code-`, e.g. `code-bob`).</param>
    /// <returns>
    ...
    /// <summary>
    /// List an account's credit payments <see href="https://partner-docs.recurly.com/v2017-09-30#operation/list_account_credit_payments">list_account_credit_payments api documentation</see>
    /// </summary>
    /// <param name="account_id">Account ID or code (use prefix: `code-`, e.g. `code-bob`).</param>
    /// <param name="limit">Limit number of records 1-200.</param>
    /// <param name="order">Sort order.</param>
    ...
    /// <summary>
    /// List an account's invoices <see href="https://partner-docs.recurly.com/v2017-09-30#operation/list_account_invoices">list_account_invoices api documentation</see>
    /// </summary>
    /// <param name="account_id">Account ID or code (use prefix: `code-`, e.g. `code-bob`).</param>
    /// <param name="ids">Filter results by their IDs. Up to 200 IDs can be passed at once using  commas as separators, e.g. `ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6`.    **Important notes:**  * The `ids` parameter cannot be used with any other ordering or filtering    parameters (`limit`, `order`, `sort`, `begin_time`, `end_time`, etc)  * Invalid or unknown IDs will be ignored, so you should check that the    results correspond to your request.  * Records are returned in an arbitrary order. Since results are all    returned at once you can sort the records yourself.  </param>
    /// <param name="limit">Limit number of records 1-200.</param>
    ...
    /// <summary>
    /// Create an invoice for pending line items <see href="https://partner-docs.recurly.com/v2017-09-30#operation/create_invoice">create_invoice api documentation</see>
    /// </summary>
    /// <param name="account_id">Account ID or code (use prefix: `code-`, e.g. `code-bob`).</param>
    /// <param name="body"></param>
    /// <returns>
    ...
    /// <summary>
    /// Preview new invoice for pending line items <see href="https://partner-docs.recurly.com/v2017-09-30#operation/preview_invoice">preview_invoice api documentation</see>
    /// </summary>
    /// <param name="account_id">Account ID or code (use prefix: `code-`, e.g. `code-bob`).</param>
    /// <param name="body"></param>
    /// <returns>
    ...
    /// <summary>
    /// List an account's line items <see href="https://partner-docs.recurly.com/v2017-09-30#operation/list_account_line_items">list_account_line_items api documentation</see>
    /// </summary>
    /// <param name="account_id">Account ID or code (use prefix: `code-`, e.g. `code-bob`).</param>
    /// <param name="ids">Filter results by their IDs. Up to 200 IDs can be passed at once using  commas as separators, e.g. `ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6`.    **Important notes:**  * The `ids` parameter cannot be used with any other ordering or filtering    parameters (`limit`, `order`, `sort`, `begin_time`, `end_time`, etc)  * Invalid or unknown IDs will be ignored, so you should check that the    results correspond to your request.  * Records are returned in an arbitrary order. Since results are all    returned at once you can sort the records yourself.  </param>
    /// <param name="limit">Limit number of records 1-200.</param>
    ...
    /// <summary>
    /// Create a new line item for the account <see href="https://partner-docs.recurly.com/v2017-09-30#operation/create_line_item">create_line_item api documentation</see>
    /// </summary>
    /// <param name="account_id">Account ID or code (use prefix: `code-`, e.g. `code-bob`).</param>
    /// <param name="body"></param>
    /// <returns>
    ...
    /// <summary>
    /// Fetch a list of an account's notes <see href="https://partner-docs.recurly.com/v2017-09-30#operation/list_account_notes">list_account_notes api documentation</see>
    /// </summary>
    /// <param name="account_id">Account ID or code (use prefix: `code-`, e.g. `code-bob`).</param>
    /// <param name="ids">Filter results by their IDs. Up to 200 IDs can be passed at once using  commas as separators, e.g. `ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6`.    **Important notes:**  * The `ids` parameter cannot be used with any other ordering or filtering    parameters (`limit`, `order`, `sort`, `begin_time`, `end_time`, etc)  * Invalid or unknown IDs will be ignored, so you should check that the    results correspond to your request.  * Records are returned in an arbitrary order. Since results are all    returned at once you can sort the records yourself.  </param>
    /// <returns>
    ...
    /// <summary>
    /// Fetch an account note <see href="https://partner-docs.recurly.com/v2017-09-30#operation/get_account_note">get_account_note api documentation</see>
    /// </summary>
    /// <param name="account_id">Account ID or code (use prefix: `code-`, e.g. `code-bob`).</param>
    ...
    /// <summary>
    /// Fetch a list of an account's shipping addresses <see href="https://partner-docs.recurly.com/v2017-09-30#operation/list_shipping_addresses">list_shipping_addresses api documentation</see>
    /// </summary>
    /// <param name="account_id">Account ID or code (use prefix: `code-`, e.g. `code-bob`).</param>
    /// <param name="ids">Filter results by their IDs. Up to 200 IDs can be passed at once using  commas as separators, e.g. `ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6`.    **Important notes:**  * The `ids` parameter cannot be used with any other ordering or filtering    parameters (`limit`, `order`, `sort`, `begin_time`, `end_time`, etc)  * Invalid or unknown IDs will be ignored, so you should check that the    results correspond to your request.  * Records are returned in an arbitrary order. Since results are all    returned at once you can sort the records yourself.  </param>
    /// <param name="limit">Limit number of records 1-200.</param>
    ...
    /// <summary>
    /// Create a new shipping address for the account <see href="https://partner-docs.recurly.com/v2017-09-30#operation/create_shipping_address">create_shipping_address api documentation</see>
    /// </summary>
    /// <param name="account_id">Account ID or code (use prefix: `code-`, e.g. `code-bob`).</param>
    /// <param name="body"></param>
    /// <returns>
    ...
    /// <summary>
    /// Fetch an account's shipping address <see href="https://partner-docs.recurly.com/v2017-09-30#operation/get_shipping_address">get_shipping_address api documentation</see>
    /// </summary>
    /// <param name="account_id">Account ID or code (use prefix: `code-`, e.g. `code-bob`).</param>
    ...
    /// <summary>
    /// Update an account's shipping address <see href="https://partner-docs.recurly.com/v2017-09-30#operation/update_shipping_address">update_shipping_address api documentation</see>
    /// </summary>
    /// <param name="account_id">Account ID or code (use prefix: `code-`, e.g. `code-bob`).</param>
    /// <param name="shipping_address_id">Shipping Address ID.</param>
    /// <param name="body"></param>
    ...
    /// <summary>
    /// Remove an account's shipping address <see href="https://partner-docs.recurly.com/v2017-09-30#operation/remove_shipping_address">remove_shipping_address api documentation</see>
    /// </summary>
    /// <param name="account_id">Account ID or code (use prefix: `code-`, e.g. `code-bob`).</param>
    /// <param name="shipping_address_id">Shipping Address ID.</param>
    /// <returns>
    ...
    /// <summary>
    /// List an account's subscriptions <see href="https://partner-docs.recurly.com/v2017-09-30#operation/list_account_subscriptions">list_account_subscriptions api documentation</see>
    /// </summary>
    /// <param name="account_id">Account ID or code (use prefix: `code-`, e.g. `code-bob`).</param>
    /// <param name="ids">Filter results by their IDs. Up to 200 IDs can be passed at once using  commas as separators, e.g. `ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6`.    **Important notes:**  * The `ids` parameter cannot be used with any other ordering or filtering    parameters (`limit`, `order`, `sort`, `begin_time`, `end_time`, etc)  * Invalid or unknown IDs will be ignored, so you should check that the    results correspond to your request.  * Records are returned in an arbitrary order. Since results are all    returned at once you can sort the records yourself.  </param>
    /// <param name="limit">Limit number of records 1-200.</param>
    ...
    /// <summary>
    /// List an account's transactions <see href="https://partner-docs.recurly.com/v2017-09-30#operation/list_account_transactions">list_account_transactions api documentation</see>
    /// </summary>
    /// <param name="account_id">Account ID or code (use prefix: `code-`, e.g. `code-bob`).</param>
    /// <param name="ids">Filter results by their IDs. Up to 200 IDs can be passed at once using  commas as separators, e.g. `ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6`.    **Important notes:**  * The `ids` parameter cannot be used with any other ordering or filtering    parameters (`limit`, `order`, `sort`, `begin_time`, `end_time`, etc)  * Invalid or unknown IDs will be ignored, so you should check that the    results correspond to your request.  * Records are returned in an arbitrary order. Since results are all    returned at once you can sort the records yourself.  </param>
    /// <param name="limit">Limit number of records 1-200.</param>
    ...
    /// <summary>
    /// List a site's account acquisition data <see href="https://partner-docs.recurly.com/v2017-09-30#operation/list_account_acquisition">list_account_acquisition api documentation</see>
    /// </summary>
    /// <param name="ids">Filter results by their IDs. Up to 200 IDs can be passed at once using  commas as separators, e.g. `ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6`.    **Important notes:**  * The `ids` parameter cannot be used with any other ordering or filtering    parameters (`limit`, `order`, `sort`, `begin_time`, `end_time`, etc)  * Invalid or unknown IDs will be ignored, so you should check that the    results correspond to your request.  * Records are returned in an arbitrary order. Since results are all    returned at once you can sort the records yourself.  </param>
    /// <param name="limit">Limit number of records 1-200.</param>
    /// <param name="order">Sort order.</param>
    ...
    /// <summary>
    /// List a site's coupons <see href="https://partner-docs.recurly.com/v2017-09-30#operation/list_coupons">list_coupons api documentation</see>
    /// </summary>
    /// <param name="ids">Filter results by their IDs. Up to 200 IDs can be passed at once using  commas as separators, e.g. `ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6`.    **Important notes:**  * The `ids` parameter cannot be used with any other ordering or filtering    parameters (`limit`, `order`, `sort`, `begin_time`, `end_time`, etc)  * Invalid or unknown IDs will be ignored, so you should check that the    results correspond to your request.  * Records are returned in an arbitrary order. Since results are all    returned at once you can sort the records yourself.  </param>
    /// <param name="limit">Limit number of records 1-200.</param>
    /// <param name="order">Sort order.</param>
    ...
    /// <summary>
    /// Create a new coupon <see href="https://partner-docs.recurly.com/v2017-09-30#operation/create_coupon">create_coupon api documentation</see>
    /// </summary>
    /// <param name="body"></param>
    /// <returns>
    /// A new coupon.
    ...
    /// <summary>
    /// Fetch a coupon <see href="https://partner-docs.recurly.com/v2017-09-30#operation/get_coupon">get_coupon api documentation</see>
    /// </summary>
    ...
    /// <summary>
    /// Update an active coupon <see href="https://partner-docs.recurly.com/v2017-09-30#operation/update_coupon">update_coupon api documentation</see>
    /// </summary>
    /// <param name="coupon_id">Coupon ID or code (use prefix: `code-`, e.g. `code-10off`).</param>
    /// <param name="body"></param>
    /// <returns>
    ...
    /// <summary>
    /// List unique coupon codes associated with a bulk coupon <see href="https://partner-docs.recurly.com/v2017-09-30#operation/list_unique_coupon_codes">list_unique_coupon_codes api documentation</see>
    /// </summary>
    /// <param name="coupon_id">Coupon ID or code (use prefix: `code-`, e.g. `code-10off`).</param>
    /// <param name="ids">Filter results by their IDs. Up to 200 IDs can be passed at once using  commas as separators, e.g. `ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6`.    **Important notes:**  * The `ids` parameter cannot be used with any other ordering or filtering    parameters (`limit`, `order`, `sort`, `begin_time`, `end_time`, etc)  * Invalid or unknown IDs will be ignored, so you should check that the    results correspond to your request.  * Records are returned in an arbitrary order. Since results are all    returned at once you can sort the records yourself.  </param>
    /// <param name="limit">Limit number of records 1-200.</param>
    ...
    /// <summary>
    /// List a site's credit payments <see href="https://partner-docs.recurly.com/v2017-09-30#operation/list_credit_payments">list_credit_payments api documentation</see>
    /// </summary>
    /// <param name="limit">Limit number of records 1-200.</param>
    /// <param name="order">Sort order.</param>
    /// <param name="sort">Sort field. You *really* only want to sort by `updated_at` in ascending  order. In descending order updated records will move behind the cursor and could  prevent some records from being returned.  </param>
    ...
    /// <summary>
    /// Fetch a credit payment <see href="https://partner-docs.recurly.com/v2017-09-30#operation/get_credit_payment">get_credit_payment api documentation</see>
    /// </summary>
    ...
    /// <summary>
    /// List a site's invoices <see href="https://partner-docs.recurly.com/v2017-09-30#operation/list_invoices">list_invoices api documentation</see>
    /// </summary>
    /// <param name="ids">Filter results by their IDs. Up to 200 IDs can be passed at once using  commas as separators, e.g. `ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6`.    **Important notes:**  * The `ids` parameter cannot be used with any other ordering or filtering    parameters (`limit`, `order`, `sort`, `begin_time`, `end_time`, etc)  * Invalid or unknown IDs will be ignored, so you should check that the    results correspond to your request.  * Records are returned in an arbitrary order. Since results are all    returned at once you can sort the records yourself.  </param>
    /// <param name="limit">Limit number of records 1-200.</param>
    /// <param name="order">Sort order.</param>
    ...
    /// <summary>
    /// Fetch an invoice <see href="https://partner-docs.recurly.com/v2017-09-30#operation/get_invoice">get_invoice api documentation</see>
    /// </summary>
    ...
    /// <summary>
    /// Collect a pending or past due, automatic invoice <see href="https://partner-docs.recurly.com/v2017-09-30#operation/collect_invoice">collect_invoice api documentation</see>
    /// </summary>
    /// <param name="invoice_id">Invoice ID or number (use prefix: `number-`, e.g. `number-1000`).</param>
    /// <returns>
    /// The updated invoice.
    ...
    /// <summary>
    /// Mark an open invoice as failed <see href="https://partner-docs.recurly.com/v2017-09-30#operation/fail_invoice">fail_invoice api documentation</see>
    /// </summary>
    /// <param name="invoice_id">Invoice ID or number (use prefix: `number-`, e.g. `number-1000`).</param>
    /// <returns>
    /// The updated invoice.
    ...
    /// <summary>
    /// Mark an open invoice as successful <see href="https://partner-docs.recurly.com/v2017-09-30#operation/mark_invoice_successful">mark_invoice_successful api documentation</see>
    /// </summary>
    /// <param name="invoice_id">Invoice ID or number (use prefix: `number-`, e.g. `number-1000`).</param>
    /// <returns>
    /// The updated invoice.
    ...
    /// <summary>
    /// Reopen a closed, manual invoice <see href="https://partner-docs.recurly.com/v2017-09-30#operation/reopen_invoice">reopen_invoice api documentation</see>
    /// </summary>
    /// <param name="invoice_id">Invoice ID or number (use prefix: `number-`, e.g. `number-1000`).</param>
    /// <returns>
    /// The updated invoice.
    ...
    /// <summary>
    /// List a invoice's line items <see href="https://partner-docs.recurly.com/v2017-09-30#operation/list_invoice_line_items">list_invoice_line_items api documentation</see>
    /// </summary>
    /// <param name="invoice_id">Invoice ID or number (use prefix: `number-`, e.g. `number-1000`).</param>
    /// <param name="ids">Filter results by their IDs. Up to 200 IDs can be passed at once using  commas as separators, e.g. `ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6`.    **Important notes:**  * The `ids` parameter cannot be used with any other ordering or filtering    parameters (`limit`, `order`, `sort`, `begin_time`, `end_time`, etc)  * Invalid or unknown IDs will be ignored, so you should check that the    results correspond to your request.  * Records are returned in an arbitrary order. Since results are all    returned at once you can sort the records yourself.  </param>
    /// <param name="limit">Limit number of records 1-200.</param>
    ...
    /// <summary>
    /// Show the coupon redemptions applied to an invoice <see href="https://partner-docs.recurly.com/v2017-09-30#operation/list_invoice_coupon_redemptions">list_invoice_coupon_redemptions api documentation</see>
    /// </summary>
    /// <param name="invoice_id">Invoice ID or number (use prefix: `number-`, e.g. `number-1000`).</param>
    /// <param name="ids">Filter results by their IDs. Up to 200 IDs can be passed at once using  commas as separators, e.g. `ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6`.    **Important notes:**  * The `ids` parameter cannot be used with any other ordering or filtering    parameters (`limit`, `order`, `sort`, `begin_time`, `end_time`, etc)  * Invalid or unknown IDs will be ignored, so you should check that the    results correspond to your request.  * Records are returned in an arbitrary order. Since results are all    returned at once you can sort the records yourself.  </param>
    /// <returns>
    ...
    /// <summary>
    /// List an invoice's related credit or charge invoices <see href="https://partner-docs.recurly.com/v2017-09-30#operation/list_related_invoices">list_related_invoices api documentation</see>
    /// </summary>
    /// <param name="invoice_id">Invoice ID or number (use prefix: `number-`, e.g. `number-1000`).</param>
    /// <returns>
    ...
    /// <summary>
    /// Refund an invoice <see href="https://partner-docs.recurly.com/v2017-09-30#operation/refund_invoice">refund_invoice api documentation</see>
    /// </summary>
    /// <param name="invoice_id">Invoice ID or number (use prefix: `number-`, e.g. `number-1000`).</param>
    /// <param name="body"></param>
    /// <returns>
    ...
    /// <summary>
    /// List a site's line items <see href="https://partner-docs.recurly.com/v2017-09-30#operation/list_line_items">list_line_items api documentation</see>
    /// </summary>
    /// <param name="ids">Filter results by their IDs. Up to 200 IDs can be passed at once using  commas as separators, e.g. `ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6`.    **Important notes:**  * The `ids` parameter cannot be used with any other ordering or filtering    parameters (`limit`, `order`, `sort`, `begin_time`, `end_time`, etc)  * Invalid or unknown IDs will be ignored, so you should check that the    results correspond to your request.  * Records are returned in an arbitrary order. Since results are all    returned at once you can sort the records yourself.  </param>
    /// <param name="limit">Limit number of records 1-200.</param>
    /// <param name="order">Sort order.</param>
    ...
    /// <summary>
    /// Fetch a line item <see href="https://partner-docs.recurly.com/v2017-09-30#operation/get_line_item">get_line_item api documentation</see>
    /// </summary>
    ...
    /// <summary>
    /// Delete an uninvoiced line item <see href="https://partner-docs.recurly.com/v2017-09-30#operation/remove_line_item">remove_line_item api documentation</see>
    /// </summary>
    /// <param name="line_item_id">Line Item ID.</param>
    /// <returns>
    /// Line item deleted.
    ...
    /// <summary>
    /// List a site's plans <see href="https://partner-docs.recurly.com/v2017-09-30#operation/list_plans">list_plans api documentation</see>
    /// </summary>
    /// <param name="ids">Filter results by their IDs. Up to 200 IDs can be passed at once using  commas as separators, e.g. `ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6`.    **Important notes:**  * The `ids` parameter cannot be used with any other ordering or filtering    parameters (`limit`, `order`, `sort`, `begin_time`, `end_time`, etc)  * Invalid or unknown IDs will be ignored, so you should check that the    results correspond to your request.  * Records are returned in an arbitrary order. Since results are all    returned at once you can sort the records yourself.  </param>
    /// <param name="limit">Limit number of records 1-200.</param>
    /// <param name="order">Sort order.</param>
    ...
    /// <summary>
    /// Create a plan <see href="https://partner-docs.recurly.com/v2017-09-30#operation/create_plan">create_plan api documentation</see>
    /// </summary>
    /// <param name="body"></param>
    /// <returns>
    /// A plan.
    ...
    /// <summary>
    /// Fetch a plan <see href="https://partner-docs.recurly.com/v2017-09-30#operation/get_plan">get_plan api documentation</see>
    /// </summary>
    ...
    /// <summary>
    /// Update a plan <see href="https://partner-docs.recurly.com/v2017-09-30#operation/update_plan">update_plan api documentation</see>
    /// </summary>
    /// <param name="plan_id">Plan ID or code (use prefix: `code-`, e.g. `code-gold`).</param>
    /// <param name="body"></param>
    /// <returns>
    ...
    /// <summary>
    /// Remove a plan <see href="https://partner-docs.recurly.com/v2017-09-30#operation/remove_plan">remove_plan api documentation</see>
    /// </summary>
    /// <param name="plan_id">Plan ID or code (use prefix: `code-`, e.g. `code-gold`).</param>
    /// <returns>
    /// Plan deleted
    ...
    /// <summary>
    /// List a plan's add-ons <see href="https://partner-docs.recurly.com/v2017-09-30#operation/list_plan_add_ons">list_plan_add_ons api documentation</see>
    /// </summary>
    /// <param name="plan_id">Plan ID or code (use prefix: `code-`, e.g. `code-gold`).</param>
    /// <param name="ids">Filter results by their IDs. Up to 200 IDs can be passed at once using  commas as separators, e.g. `ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6`.    **Important notes:**  * The `ids` parameter cannot be used with any other ordering or filtering    parameters (`limit`, `order`, `sort`, `begin_time`, `end_time`, etc)  * Invalid or unknown IDs will be ignored, so you should check that the    results correspond to your request.  * Records are returned in an arbitrary order. Since results are all    returned at once you can sort the records yourself.  </param>
    /// <param name="limit">Limit number of records 1-200.</param>
    ...
    /// <summary>
    /// Create an add-on <see href="https://partner-docs.recurly.com/v2017-09-30#operation/create_plan_add_on">create_plan_add_on api documentation</see>
    /// </summary>
    /// <param name="plan_id">Plan ID or code (use prefix: `code-`, e.g. `code-gold`).</param>
    /// <param name="body"></param>
    /// <returns>
    ...
    /// <summary>
    /// Fetch a plan's add-on <see href="https://partner-docs.recurly.com/v2017-09-30#operation/get_plan_add_on">get_plan_add_on api documentation</see>
    /// </summary>
    /// <param name="plan_id">Plan ID or code (use prefix: `code-`, e.g. `code-gold`).</param>
    ...
    /// <summary>
    /// Update an add-on <see href="https://partner-docs.recurly.com/v2017-09-30#operation/update_plan_add_on">update_plan_add_on api documentation</see>
    /// </summary>
    /// <param name="plan_id">Plan ID or code (use prefix: `code-`, e.g. `code-gold`).</param>
    /// <param name="add_on_id">Add-on ID or code (use prefix: `code-`, e.g. `code-gold`).</param>
    /// <param name="body"></param>
    ...
    /// <summary>
    /// Remove an add-on <see href="https://partner-docs.recurly.com/v2017-09-30#operation/remove_plan_add_on">remove_plan_add_on api documentation</see>
    /// </summary>
    /// <param name="plan_id">Plan ID or code (use prefix: `code-`, e.g. `code-gold`).</param>
    /// <param name="add_on_id">Add-on ID or code (use prefix: `code-`, e.g. `code-gold`).</param>
    /// <returns>
    ...
    /// <summary>
    /// List a site's add-ons <see href="https://partner-docs.recurly.com/v2017-09-30#operation/list_add_ons">list_add_ons api documentation</see>
    /// </summary>
    /// <param name="ids">Filter results by their IDs. Up to 200 IDs can be passed at once using  commas as separators, e.g. `ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6`.    **Important notes:**  * The `ids` parameter cannot be used with any other ordering or filtering    parameters (`limit`, `order`, `sort`, `begin_time`, `end_time`, etc)  * Invalid or unknown IDs will be ignored, so you should check that the    results correspond to your request.  * Records are returned in an arbitrary order. Since results are all    returned at once you can sort the records yourself.  </param>
    /// <param name="limit">Limit number of records 1-200.</param>
    /// <param name="order">Sort order.</param>
    ...
    /// <summary>
    /// Fetch an add-on <see href="https://partner-docs.recurly.com/v2017-09-30#operation/get_add_on">get_add_on api documentation</see>
    /// </summary>
    /// <param name="add_on_id">Add-on ID or code (use prefix: `code-`, e.g. `code-gold`).</param>
    /// <returns>
    /// An add-on.
    ...
    /// <summary>
    /// List a site's subscriptions <see href="https://partner-docs.recurly.com/v2017-09-30#operation/list_subscriptions">list_subscriptions api documentation</see>
    /// </summary>
    /// <param name="ids">Filter results by their IDs. Up to 200 IDs can be passed at once using  commas as separators, e.g. `ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6`.    **Important notes:**  * The `ids` parameter cannot be used with any other ordering or filtering    parameters (`limit`, `order`, `sort`, `begin_time`, `end_time`, etc)  * Invalid or unknown IDs will be ignored, so you should check that the    results correspond to your request.  * Records are returned in an arbitrary order. Since results are all    returned at once you can sort the records yourself.  </param>
    /// <param name="limit">Limit number of records 1-200.</param>
    /// <param name="order">Sort order.</param>
    ...
    /// <summary>
    /// Create a new subscription <see href="https://partner-docs.recurly.com/v2017-09-30#operation/create_subscription">create_subscription api documentation</see>
    /// </summary>
    /// <param name="body"></param>
    /// <returns>
    /// A subscription.
    ...
    /// <summary>
    /// Fetch a subscription <see href="https://partner-docs.recurly.com/v2017-09-30#operation/get_subscription">get_subscription api documentation</see>
    /// </summary>
    ...
    /// <summary>
    /// Modify a subscription <see href="https://partner-docs.recurly.com/v2017-09-30#operation/modify_subscription">modify_subscription api documentation</see>
    /// </summary>
    /// <param name="subscription_id">Subscription ID or UUID (use prefix: `uuid-`, e.g. `uuid-123457890`).</param>
    /// <param name="body"></param>
    /// <returns>
    ...
    /// <summary>
    /// Terminate a subscription <see href="https://partner-docs.recurly.com/v2017-09-30#operation/terminate_subscription">terminate_subscription api documentation</see>
    /// </summary>
    /// <param name="subscription_id">Subscription ID or UUID (use prefix: `uuid-`, e.g. `uuid-123457890`).</param>
    ...
    /// <summary>
    /// Cancel a subscription <see href="https://partner-docs.recurly.com/v2017-09-30#operation/cancel_subscription">cancel_subscription api documentation</see>
    /// </summary>
    /// <param name="subscription_id">Subscription ID or UUID (use prefix: `uuid-`, e.g. `uuid-123457890`).</param>
    /// <returns>
    ...
    /// <summary>
    /// Reactivate a canceled subscription <see href="https://partner-docs.recurly.com/v2017-09-30#operation/reactivate_subscription">reactivate_subscription api documentation</see>
    /// </summary>
    /// <param name="subscription_id">Subscription ID or UUID (use prefix: `uuid-`, e.g. `uuid-123457890`).</param>
    /// <returns>
    ...
    /// <summary>
    /// Fetch a subscription's pending change <see href="https://partner-docs.recurly.com/v2017-09-30#operation/get_subscription_change">get_subscription_change api documentation</see>
    /// </summary>
    /// <param name="subscription_id">Subscription ID or UUID (use prefix: `uuid-`, e.g. `uuid-123457890`).</param>
    /// <returns>
    ...
    /// <summary>
    /// Create a new subscription change <see href="https://partner-docs.recurly.com/v2017-09-30#operation/create_subscription_change">create_subscription_change api documentation</see>
    /// </summary>
    /// <param name="subscription_id">Subscription ID or UUID (use prefix: `uuid-`, e.g. `uuid-123457890`).</param>
    /// <param name="body"></param>
    /// <returns>
    ...
    /// <summary>
    /// Delete the pending subscription change <see href="https://partner-docs.recurly.com/v2017-09-30#operation/remove_subscription_change">remove_subscription_change api documentation</see>
    /// </summary>
    /// <param name="subscription_id">Subscription ID or UUID (use prefix: `uuid-`, e.g. `uuid-123457890`).</param>
    /// <returns>
    ...
    /// <summary>
    /// List a subscription's invoices <see href="https://partner-docs.recurly.com/v2017-09-30#operation/list_subscription_invoices">list_subscription_invoices api documentation</see>
    /// </summary>
    /// <param name="subscription_id">Subscription ID or UUID (use prefix: `uuid-`, e.g. `uuid-123457890`).</param>
    /// <param name="ids">Filter results by their IDs. Up to 200 IDs can be passed at once using  commas as separators, e.g. `ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6`.    **Important notes:**  * The `ids` parameter cannot be used with any other ordering or filtering    parameters (`limit`, `order`, `sort`, `begin_time`, `end_time`, etc)  * Invalid or unknown IDs will be ignored, so you should check that the    results correspond to your request.  * Records are returned in an arbitrary order. Since results are all    returned at once you can sort the records yourself.  </param>
    /// <param name="limit">Limit number of records 1-200.</param>
    ...
    /// <summary>
    /// List a subscription's line items <see href="https://partner-docs.recurly.com/v2017-09-30#operation/list_subscription_line_items">list_subscription_line_items api documentation</see>
    /// </summary>
    /// <param name="subscription_id">Subscription ID or UUID (use prefix: `uuid-`, e.g. `uuid-123457890`).</param>
    /// <param name="ids">Filter results by their IDs. Up to 200 IDs can be passed at once using  commas as separators, e.g. `ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6`.    **Important notes:**  * The `ids` parameter cannot be used with any other ordering or filtering    parameters (`limit`, `order`, `sort`, `begin_time`, `end_time`, etc)  * Invalid or unknown IDs will be ignored, so you should check that the    results correspond to your request.  * Records are returned in an arbitrary order. Since results are all    returned at once you can sort the records yourself.  </param>
    /// <param name="limit">Limit number of records 1-200.</param>
    ...
    /// <summary>
    /// List a site's transactions <see href="https://partner-docs.recurly.com/v2017-09-30#operation/list_transactions">list_transactions api documentation</see>
    /// </summary>
    /// <param name="ids">Filter results by their IDs. Up to 200 IDs can be passed at once using  commas as separators, e.g. `ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6`.    **Important notes:**  * The `ids` parameter cannot be used with any other ordering or filtering    parameters (`limit`, `order`, `sort`, `begin_time`, `end_time`, etc)  * Invalid or unknown IDs will be ignored, so you should check that the    results correspond to your request.  * Records are returned in an arbitrary order. Since results are all    returned at once you can sort the records yourself.  </param>
    /// <param name="limit">Limit number of records 1-200.</param>
    /// <param name="order">Sort order.</param>
    ...
    /// <summary>
    /// Fetch a transaction <see href="https://partner-docs.recurly.com/v2017-09-30#operation/get_transaction">get_transaction api documentation</see>
    /// </summary>
    ...
    /// <summary>
    /// Fetch a unique coupon code <see href="https://partner-docs.recurly.com/v2017-09-30#operation/get_unique_coupon_code">get_unique_coupon_code api documentation</see>
    /// </summary>
    ...
    /// <summary>
    /// Deactivate a unique coupon code <see href="https://partner-docs.recurly.com/v2017-09-30#operation/deactivate_unique_coupon_code">deactivate_unique_coupon_code api documentation</see>
    /// </summary>
    /// <param name="unique_coupon_code_id">Unique Coupon Code ID or code (use prefix: `code-`, e.g. `code-abc-8dh2-def`).</param>
    /// <returns>
    /// A unique coupon code.
    ...
    /// <summary>
    /// Restore a unique coupon code <see href="https://partner-docs.recurly.com/v2017-09-30#operation/reactivate_unique_coupon_code">reactivate_unique_coupon_code api documentation</see>
    /// </summary>
    /// <param name="unique_coupon_code_id">Unique Coupon Code ID or code (use prefix: `code-`, e.g. `code-abc-8dh2-def`).</param>
    /// <returns>
    /// A unique coupon code.
